...
- [X] Explain what a token is used for.
  -A token would be used as a placeholder for your password/username. Removing said token removes the user/logs them out. A security measure.
- [X] What steps can you take in your web apps to keep your data secure?
  -Implementing tokens.
- [X] Describe how web servers work.
  -A web server stores information and passes it along back and forth.
